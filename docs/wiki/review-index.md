...
| R3 | H | 임계치 방향 문장이 반대 | 해소(문서); P4 실측 D10 방향 9쌍 위반 0(ef18143). **구현완료(cf5a171)** — P4b 재실행 곡선에서 재확인: 제안 방식 연속 격자 9쌍 전부 비엄격 단조, 위반 0(`d10_direction=true`). 산식은 D12 로 바뀌었다 | D10 |
