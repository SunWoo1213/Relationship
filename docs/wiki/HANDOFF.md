...
갱신: 2026-09-06 23:30 (U3 완료·커밋 — U4 위임 대기)
active: **P1-pilot-dataset** | frozen: none | 브랜치: dev (origin/dev 09875aa, main bdf9f70 승격 보류). U3 커밋(해시는 journal COMMIT 줄) — 34건, ambiguous 3, trap 8, virtual_names 99. **다음: U4** new_person 6(sc-035~040, 하위 유형 등록 대상/지나가는 언급 각 3건 이상 R-5) — L-004 승인 → gen-prompt-u4 evidence 저장 → eval-agent. 그 뒤 U5(무결성·distribution 배분표[하위 유형·trap 열·schedule_utterance_scenarios]·검사 11 파일명↔category·01-plan 턴 수 규칙 한 줄·검수 패킷·--strict rc=0). P4 인계 후보: mention 단위 trap_target/expected_ask_user/char_start/antecedent_turn(schema_version 2).
